...
# class BinaryTree():
#     def __init__(self, root, ammount):
#         self.root = Node(root, ammount)
...
#             traversal += (str(start.value) + "-" + str(start.ammount))
#             traversal =self.inOrder_print(start.right, traversal)
#         return traversal

    

# tree = BinaryTree(1, [150, 50])
# tree.root.left = Node(2, [100, 20])
# tree.root.right = Node(3, [2200])
# tree.root.left.left = Node(4, [150])
# tree.root.left.right = Node(5, [900, 10])
# tree.root.right.left = Node(6, [190])
